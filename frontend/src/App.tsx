...
function App(){
 ...
 useEffect(()=>{
   if(!paperActive||!strategy?.timestamp||loading)return
   ...
   return()=>{active=false}
 },[paperActive,strategy?.timestamp,loading,source,symbol,timeframe,paperRefresh])
