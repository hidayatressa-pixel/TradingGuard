...
function App(){
 ...
 // The backend owns candle completion/idempotency. Poll the authoritative cycle every market
 // refresh instead of suppressing calls in the browser. While a position/pending action exists,
 // keep monitoring its locked instrument even if the user browses another chart.
 useEffect(()=>{
